...
# a = Tree()
# a.Insert('mojtaba','jafargholizadeh')
# a.Insert('tania','hadipour')
# a.Insert('kimia','nemati')
# a.Insert('morteza','jafar')
# a.Insert('javad','asadi')
# a.Insert('rasam','moghadam')
# a.Insert('mohamad','ghasemi')
# a.Insert('ali','gholizadeh')
# a.Insert('ali','asadi')
# a.Insert('hasan','asadi')
